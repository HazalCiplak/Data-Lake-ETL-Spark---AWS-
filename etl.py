...
def process_song_data(spark, input_data, output_data):
    """
    Loads song_data from S3 and processes it by extracting the songs and artist tables and then again loaded to another S3 bucket
    ----------
...
def process_log_data(spark, input_data, output_data):
    """
    Loads log_data from S3 and processes it by extracting the songs and artist tables and then again loaded to another S3 bucket. 
...
def main():                  
    ...
    output_data = "s3a://hazaludacitydatalake/"
